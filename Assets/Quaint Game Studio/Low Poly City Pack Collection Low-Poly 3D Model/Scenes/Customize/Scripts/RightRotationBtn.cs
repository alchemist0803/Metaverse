...
public class RightRotationBtn : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    [Range(1.0f, 1000.0f)]
    ...
    private IEnumerator TrackTimePressed()
    {
        ...
        {
            time += Time.deltaTime;
            CustomManager.sInstance.m_showCharacter.transform.Rotate(Vector3.down * 2);
            yield return null;
        }
