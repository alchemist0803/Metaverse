...
namespace Invector.vCharacterController
{
    public class vThirdPersonAnimator : vThirdPersonMotor
    {
        ...
        {
            animator.SetBool(vAnimatorParameters.IsSit, isSit);
            if (animator == null || !animator.enabled || isSit) return;
            ...
            Cursor.visible =!( inputMagnitude > 0.1f);
        }
    ...
    public static partial class vAnimatorParameters
    {
        ...
        //start dragonet 2022-4-5
        public static int IsSit = Animator.StringToHash("IsSit");
        //end
    }
}