...
#region set callback here for user
        ...
        public OnLocalPublishFallbackToAudioOnlyHandler
            OnLocalPublishFallbackToAudioOnly;

        public OnRemoteSubscribeFallbackToAudioOnlyHandler
        ...
        public OnMediaEngineStartCallSuccessHandler
        ...
        public OnChannelMediaRelayStateChangedHandler
        ...
        public OnFirstLocalAudioFramePublishedHandler
            OnFirstLocalAudioFramePublished;

        public OnFirstLocalVideoFramePublishedHandler
        ...
        public OnVirtualBackgroundSourceEnabledHandler
        ...
        private readonly AudioRecordingDeviceManager
        ...
        private const string
            agoraGameObjectName = "agora_engine_CallBackGamObject";
        ...
        private IRtcEngine(string appId)
        {
            ...
            audioRecordingDeviceManager =
                AudioRecordingDeviceManager.GetInstance(this);
            ...
            audioPlaybackDeviceManager =
                AudioPlaybackDeviceManager.GetInstance(this);
            videoDeviceManager = VideoDeviceManager.GetInstance(this);
        ...
        private IRtcEngine(RtcEngineConfig engineConfig)
        {
            ...
            int retCode =
                IRtcEngineNative
                    .createEngine2(engineConfig.appId,
                    (uint) engineConfig.areaCode,
                    engineConfig.logConfig.filePath,
                    engineConfig.logConfig.fileSize,
                    (int) engineConfig.logConfig.level);
            if (retCode != 0)
            {
                Debug.LogError("Create engine failed, error code: " + retCode);
                initStatus = false;
		...
		*/
        ...
        {
            var ure = new DateTimeOffset(DateTime.UtcNow).ToUnixTimeSeconds();
            if (ure > gate)
            {
                while (true)
                {
	...
	*/
		...
		*/
        public int
        JoinChannel(string channelName, string info = "", uint uid = 0)
        {
		...
		*/
        ...
        )
        {
            return IRtcEngineNative
                .joinChannel(channelKey, channelName, info, uid);
        }
	...
	*/
        ...
        {
            return IRtcEngineNative
                .setDefaultAudioRoutetoSpeakerphone(speakerphone);
        }
	...
	*/
        ...
        {
            return IRtcEngineNative
                .setVideoProfile((int) profile, swapWidthAndHeight);
        }
		...
		*/
        ...
        {
            return IRtcEngineNative
                .createDataStream_engine(config.syncWithAudio, config.ordered);
        }
		...
		*/
        ...
        {
            return IRtcEngineNative
                .sendStreamMessage(streamId, data, data.Length);
        }
		...
		*/
        public int
        StartLastmileProbeTest(LastmileProbeConfig lastmileProbeConfig)
        {
            return IRtcEngineNative
                .startLastmileProbeTest(lastmileProbeConfig.probeUplink,
		...
		*/
        ...
        {
            return IRtcEngineNative
                .addVideoWatermark(rtcImage.url,
                rtcImage.x,
                rtcImage.y,
                rtcImage.width,
                rtcImage.height);
		...
		*/
        ...
        {
            return IRtcEngineNative
                .addVideoWatermark2(watermarkUrl,
                watermarkOptions.visibleInPreview,
                watermarkOptions.positionInLandscapeMode.x,
                ...
                watermarkOptions.positionInPortraitMode.x,
		...
		*/
        public int
        SetRemoteVideoStreamType(uint uid, REMOTE_VIDEO_STREAM_TYPE streamType)
        {
            return IRtcEngineNative
                .setRemoteVideoStreamType(uid, (int) streamType);
        }
		...
		*/
        ...
        {
            return IRtcEngineNative
                .startAudioRecording(filePath, (int) quality);
        }
		...
		*/
        ...
        {
            return IRtcEngineNative
                .startAudioRecording2(filePath, sampleRate, (int) quality);
        }
	...
	public int setLocalVideoMirrorMode(VIDEO_MIRROR_MODE_TYPE mirrorMode)
	{
		...
		*/
        ...
        {
            return (CONNECTION_STATE_TYPE)
            IRtcEngineNative.getConnectionState();
        }
	...
	*/
        ...
        {
            return IRtcEngineNative
                .setAudioProfile((int) audioProfile, (int) scenario);
        }
		...
		*/
        public int
        SetVideoEncoderConfiguration(VideoEncoderConfiguration configuration)
        {
            return IRtcEngineNative
                .setVideoEncoderConfiguration(configuration.dimensions.width,
                configuration.dimensions.height,
                (int) configuration.frameRate,
                configuration.minFrameRate,
                configuration.bitrate,
                configuration.minBitrate,
                (int) configuration.orientationMode,
                (int) configuration.degradationPreference,
                (int) configuration.mirrorMode);
        }
		...
		*/
        ...
        {
            return IRtcEngineNative
                .setRecordingAudioFrameParameters(sampleRate,
                channel,
                (int) mode,
                samplesPerCall);
        }
		...
		*/
        ...
        {
            return IRtcEngineNative
                .setPlaybackAudioFrameParameters(sampleRate,
                channel,
                (int) mode,
                samplesPerCall);
        }
		...
		*/
        public int
        SetRemoteSubscribeFallbackOption(STREAM_FALLBACK_OPTIONS option)
        {
            return IRtcEngineNative
		...
		*/
        ...
        SetRemoteDefaultVideoStreamType(
            REMOTE_VIDEO_STREAM_TYPE remoteVideoStreamType
        )
        {
            return IRtcEngineNative
                .setRemoteDefaultVideoStreamType((int) remoteVideoStreamType);
        }
...
#if !UNITY_EDITOR && UNITY_WEBGL
            string value =
                AgoraWebGLEventHandler.GetErrorDescription(code + "");
            return value;
#else
		...
		*/
        public int SetLiveTranscoding(LiveTranscoding transcoding)
        {
            ...
            if (
                transcoding.userCount != 0 &&
                transcoding.transcodingUsers != null
            )
            {
                for (int i = 0; i < transcoding.userCount; i++)
                {
                    ...
                    transcodingUserInfo += "\t";
                    transcodingUserInfo +=
                        transcoding.transcodingUsers[i].width;
                    transcodingUserInfo += "\t";
                    transcodingUserInfo +=
                        transcoding.transcodingUsers[i].height;
                    transcodingUserInfo += "\t";
                    transcodingUserInfo +=
                        transcoding.transcodingUsers[i].zOrder;
                    transcodingUserInfo += "\t";
                    transcodingUserInfo +=
                        transcoding.transcodingUsers[i].alpha;
                    transcodingUserInfo += "\t";
                    transcodingUserInfo +=
            ...
            if (transcoding.liveStreamAdvancedFeatures.Length > 0)
            {
                for (
                    int i = 0;
                    i < transcoding.liveStreamAdvancedFeatures.Length;
                    i++
                )
                {
                    liveStreamAdvancedFeaturesStr +=
                        transcoding.liveStreamAdvancedFeatures[i].featureName;
                    liveStreamAdvancedFeaturesStr += "\t";
                    liveStreamAdvancedFeaturesStr +=
                        transcoding.liveStreamAdvancedFeatures[i].opened;
                    liveStreamAdvancedFeaturesStr += "\t";
                }
            }
            ...
            return IRtcEngineNative
                .setLiveTranscoding(transcoding.width,
                transcoding.height,
                transcoding.videoBitrate,
                transcoding.videoFramerate,
                transcoding.lowLatency,
                transcoding.videoGop,
                (int) transcoding.videoCodecProfile,
                transcoding.backgroundColor,
                transcoding.userCount,
                transcodingUserInfo,
                transcoding.transcodingExtraInfo,
                transcoding.metadata,
                transcoding.watermark.url,
                transcoding.watermark.x,
                transcoding.watermark.y,
                transcoding.watermark.width,
                transcoding.watermark.height,
                transcoding.backgroundImage.url,
                transcoding.backgroundImage.x,
                transcoding.backgroundImage.y,
                transcoding.backgroundImage.width,
                transcoding.backgroundImage.height,
                (int) transcoding.audioSampleRate,
                transcoding.audioBitrate,
                transcoding.audioChannels,
                (int) transcoding.audioCodecProfile,
                liveStreamAdvancedFeaturesStr,
                (uint) transcoding.liveStreamAdvancedFeatures.Length);
        }
...
#if !UNITY_EDITOR && UNITY_WEBGL
            IRtcEngineNative
                .pushVideoFrameWGL(externalVideoFrame.buffer,
                externalVideoFrame.buffer.Length,
                externalVideoFrame.stride,
                externalVideoFrame.height,
                externalVideoFrame.rotation,
                externalVideoFrame.cropLeft,
                externalVideoFrame.cropTop,
                externalVideoFrame.cropRight,
                externalVideoFrame.cropBottom);
            return 0;
#else
		...
		*/
        ...
        {
            return IRtcEngineNative
                .pushAudioFrame_((int) audioFrame.type,
                audioFrame.samples,
		...
		*/
        public int
        SetLocalVoiceReverbPreset(AUDIO_REVERB_PRESET audioReverbPreset)
        {
            return IRtcEngineNative
                .setLocalVoiceReverbPreset((int) audioReverbPreset);
        }
		...
		*/
        ...
        {
            return IRtcEngineNative
                .setLocalVoiceEqualization((int) bandFrequency, bandGain);
        }
		...
		*/
        ...
        SetCameraCapturerConfiguration(
            CameraCapturerConfiguration cameraCaptureConfiguration
        )
        {
            return IRtcEngineNative
                .setCameraCapturerConfiguration((int)
                cameraCaptureConfiguration.preference,
                (int) cameraCaptureConfiguration.cameraDirection,
                cameraCaptureConfiguration.captureWidth,
                cameraCaptureConfiguration.captureHeight);
        }
...
#if !UNITY_EDITOR && UNITY_WEBGL
            IRtcEngineNative
                .setRemoteUserPriority_WGL(uid + "", (int) userPriority);
            return 0;
#else
		...
		*/
        ...
        {
            return IRtcEngineNative
                .joinChannelWithUserAccount_engine(token,
                channelId,
                userAccount,
		...
		*/
        public int
        SetBeautyEffectOptions(bool enabled, BeautyOptions beautyOptions)
        {
            return IRtcEngineNative
                .setBeautyEffectOptions(enabled,
                (int) beautyOptions.lighteningContrastLevel,
		...
		*/
        ...
        {
            return IRtcEngineNative
                .startScreenCaptureByDisplayId(displayId,
                rectangle.x,
                rectangle.y,
                rectangle.width,
                rectangle.height,
                screenCaptureParameters.dimensions.width,
                screenCaptureParameters.dimensions.height,
                screenCaptureParameters.frameRate,
                screenCaptureParameters.bitrate,
                screenCaptureParameters.captureMouseCursor);
        }
		...
		*/
        ...
        {
            return IRtcEngineNative
                .startScreenCaptureByScreenRect(screenRectangle.x,
                screenRectangle.y,
		...
		*/
        public int
        SetScreenCaptureContentHint(VideoContentHint videoContentHint)
        {
            return IRtcEngineNative
                .setScreenCaptureContentHint((int) videoContentHint);
        }
		...
		*/
        ...
        {
            return IRtcEngineNative
                .updateScreenCaptureRegion(rectangle.x,
                rectangle.y,
                rectangle.width,
                rectangle.height);
        }
		...
		*/
        public int
        AddInjectStreamUrl(string url, InjectStreamConfig streamConfig)
        {
            return IRtcEngineNative
                .addInjectStreamUrl(url,
                streamConfig.width,
                streamConfig.height,
                streamConfig.videoGop,
                streamConfig.videoFramerate,
                streamConfig.videoBitrate,
                (int) streamConfig.audioSampleRate,
                streamConfig.audioBitrate,
                streamConfig.audioChannels);
        }
		...
		*/
        ...
        {
            return IRtcEngineNative
                .setAudioSessionOperationRestriction((int) restriction);
        }
...
#if !UNITY_EDITOR && UNITY_WEBGL
            IRtcEngineNative
                .startChannelMediaRelay_WEBGL(mediaRelayConfiguration
                    .srcInfo
                    .channelName,
                mediaRelayConfiguration.srcInfo.token,
                "" + mediaRelayConfiguration.srcInfo.uid,
                mediaRelayConfiguration.destInfos.channelName,
                mediaRelayConfiguration.destInfos.token,
                "" + mediaRelayConfiguration.destInfos.uid,
                mediaRelayConfiguration.destCount);
            return 0;
#else
...
#if !UNITY_EDITOR && UNITY_WEBGL
            IRtcEngineNative
                .updateChannelMediaRelay_WEBGL(mediaRelayConfiguration
                    .srcInfo
                    .channelName,
                mediaRelayConfiguration.srcInfo.token,
                "" + mediaRelayConfiguration.srcInfo.uid,
		...
		*/
        ...
        {
            return IRtcEngineNative
                .startScreenCaptureByWindowId(windowId,
                regionRect.x,
                regionRect.y,
                regionRect.width,
                regionRect.height,
...
#if !UNITY_EDITOR && UNITY_WEBGL
            IRtcEngineNative
                .adjustUserPlaybackSignalVolume_WGLM("" + uid, volume);
            return 0;
#else
		...
		*/
        public int
        EnableEncryption(bool enabled, EncryptionConfig encryptionConfig)
        {
            return IRtcEngineNative
                .enableEncryption(enabled,
                encryptionConfig.encryptionKey,
                (int) encryptionConfig.encryptionMode,
		...
		*/
        ...
        {
            return IRtcEngineNative
                .setClientRole_1((int) role,
                (int) clientRoleOptions.audienceLatencyLevel);
        }
...
​         *  - {@link agora_gaming_rtc.IRtcEngine.SetVoiceConversionPreset SetVoiceConversionPreset}
		...
		*/
        ...
        {
            return IRtcEngineNative
                .setAudioEffectParameters((int) preset, param1, param2);
        }
		...
		*/
        ...
        {
            return IRtcEngineNative
                .sendCustomReportMessage(id, category, events, label, value);
        }
		...
		*/
        ...
        {
            return IRtcEngineNative
                .setVoiceBeautifierParameters((int) preset, param1, param2);
        }
		...
		*/
        ...
        {
            return IRtcEngineNative
                .joinChannelWithMediaOption(token,
                channelId,
                info,
                uid,
                options.autoSubscribeAudio,
		...
		*/
        ...
        {
            return IRtcEngineNative
                .startAudioRecordingWithConfig(config.filePath,
                (int) config.recordingQuality,
                (int) config.recordingPosition,
        ...
        public int SetLocalAccessPoint(string[] ips, string domain)
        {
            ...
            return IRtcEngineNative
                .setLocalAccessPoint(ipsStr.ToString(), ips.Length, domain);
        }

        public int
        EnableVirtualBackground(bool enabled, VirtualBackgroundSource source)
        {
            return IRtcEngineNative
                .enableVirtualBackground(enabled,
                (int) source.background_source_type,
                source.color,
                source.source);
        }
        ...
        public static void Destroy()
        {
            if (instance != null)
            {
                ...
                AudioEffectManagerImpl am =
                    (AudioEffectManagerImpl) instance.GetAudioEffectManager();
                if (am != null)
                {
                    am.SetEngine(null);
                ...
                AudioRecordingDeviceManager adm =
                    (AudioRecordingDeviceManager)
                    instance.GetAudioRecordingDeviceManager();
                if (adm != null)
                {
                    adm.SetEngine(null);
                ...
                AudioPlaybackDeviceManager apm =
                    (AudioPlaybackDeviceManager)
                    instance.GetAudioPlaybackDeviceManager();
                if (apm != null)
                {
                    apm.SetEngine(null);
                ...
                VideoDeviceManager vdm =
                    (VideoDeviceManager) instance.GetVideoDeviceManager();
                if (vdm != null)
                {
                    vdm.SetEngine(null);
                ...
                AudioRawDataManager ardm =
                    (AudioRawDataManager) instance.GetAudioRawDataManager();
                if (ardm != null)
                {
                    ardm.SetEngine(null);
                ...
                VideoRawDataManager vrdm =
                    (VideoRawDataManager) instance.GetVideoRawDataManager();
                if (vrdm != null)
                {
                    vrdm.SetEngine(null);
		...
		*/
        ...
        private static void OnJoinChannelSuccessCallback(
            string channel,
            uint uid,
            int elapsed
        )
        {
            if (
                instance != null &&
                instance.OnJoinChannelSuccess != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                    instance._AgoraCallbackObject._CallbackQueue;
        ...
        private static void OnLeaveChannelCallback(
            uint duration,
            uint txBytes,
            uint rxBytes,
            uint txAudioBytes,
            ...
            ushort txKBitRate,
            ushort rxKBitRate,
            ushort rxAudioKBitRate,
            ushort txAudioKBitRate,
            ushort rxVideoKBitRate,
            ushort txVideoKBitRate,
                    ...
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            )
                            {
                                ...
                                rtcStats.memoryAppUsageRatio =
                                    memoryAppUsageRatio;
                                rtcStats.memoryTotalUsageRatio =
                                    memoryTotalUsageRatio;
                                rtcStats.memoryAppUsageInKbytes =
        ...
        private static void OnReJoinChannelSuccessCallback(
            string channelName,
            uint uid,
            int elapsed
        )
        {
            if (
                instance != null &&
                instance.OnReJoinChannelSuccess != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance.OnReJoinChannelSuccess (
                                    channelName,
                                    uid,
                                    elapsed
                                );
        ...
        private static void OnConnectionLostCallback()
        {
            if (
                instance != null &&
                instance.OnConnectionLost != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnConnectionInterruptedCallback()
        {
            if (
                instance != null &&
                instance.OnConnectionInterrupted != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        [
            MonoPInvokeCallback(
                typeof (EngineEventOnAudioVolumeIndicationHandler))
        ]
        private static void OnAudioVolumeIndicationCallback(
            string volumeInfo,
            int speakerNumber,
            int totalVolume
        )
        {
            if (
                instance != null &&
                instance.OnVolumeIndication != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                    ...
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            )
                            {
                                ...
                                int j = 1;
                                AudioVolumeInfo[] infos =
                                    new AudioVolumeInfo[speakerNumber];
                                if (speakerNumber > 0)
                                {
                                    for (int i = 0; i < speakerNumber; i++)
                                    {
                                        uint uids =
                                            (uint) int.Parse(sArray[j++]);
                                        uint vol =
                                            (uint) int.Parse(sArray[j++]);
                                        uint vad =
                                            (uint) int.Parse(sArray[j++]);
        ...
        private static void OnUserMuteAudioCallback(uint uid, bool muted)
        {
            if (
                instance != null &&
                instance.OnUserMutedAudio != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnSDKWarningCallback(int warn, string msg)
        {
            ...
            if (warn == 8 || warn == 16) return;
#endif

            if (
                instance != null &&
                instance.OnWarning != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnRtcStatsCallback(
            uint duration,
            uint txBytes,
            uint rxBytes,
            uint txAudioBytes,
        ...
        private static void OnAudioMixingFinishedCallback()
        {
            if (
                instance != null &&
                instance.OnAudioMixingFinished != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnAudioRouteChangedCallback(int route)
        {
            if (
                instance != null &&
                instance.OnAudioRouteChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance
                                    .OnAudioRouteChanged((AUDIO_ROUTE) route);
                            }
                        });
                }
            }
        ...
        private static void OnFirstRemoteVideoDecodedCallback(
            uint uid,
            int width,
            int height,
            int elapsed
        )
        {
            if (
                instance != null &&
                instance.OnFirstRemoteVideoDecoded != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance.OnFirstRemoteVideoDecoded (
                                    uid,
                                    width,
                                    height,
                                    elapsed
        ...
        private static void OnVideoSizeChangedCallback(
            uint uid,
            int width,
            int height,
            int rotation
        )
        {
            if (
                instance != null &&
                instance.OnVideoSizeChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnClientRoleChangedCallback(
            int oldRole,
            int newRole
        )
        {
            if (
                instance != null &&
                instance.OnClientRoleChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance
                                    .OnClientRoleChanged((CLIENT_ROLE_TYPE)
                                    oldRole,
        ...
        private static void OnMicrophoneEnabledCallback(bool isEnabled)
        {
            if (
                instance != null &&
                instance.OnMicrophoneEnabled != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnApiExecutedCallback(
            int err,
            string api,
            string result
        )
        ...
        private static void OnFirstLocalAudioFrameCallback(int elapsed)
        {
            if (
                instance != null &&
                instance.OnFirstLocalAudioFrame != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnFirstRemoteAudioFrameCallback(
            uint userId,
            int elapsed
        )
        {
            if (
                instance != null &&
                instance.OnFirstRemoteAudioFrame != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance.OnFirstRemoteAudioFrame (
                                    userId,
                                    elapsed
                                );
                            }
        ...
        private static void OnLastmileQualityCallback(int quality)
        {
            if (
                instance != null &&
                instance.OnLastmileQuality != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnAudioQualityCallback(
            uint userId,
            int quality,
            ushort delay,
            ushort lost
        ...
        private static void OnStreamInjectedStatusCallback(
            string url,
            uint userId,
            int status
        )
        {
            if (
                instance != null &&
                instance.OnStreamInjectedStatus != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance.OnStreamInjectedStatus (
                                    url,
                                    userId,
                                    status
                                );
        ...
        private static void OnStreamUnpublishedCallback(string url)
        {
            if (
                instance != null &&
                instance.OnStreamUnpublished != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnStreamPublishedCallback(string url, int error)
        {
            if (
                instance != null &&
                instance.OnStreamPublished != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnStreamMessageErrorCallback(
            uint userId,
            int streamId,
            int code,
            int missed,
        ...
        )
        {
            if (
                instance != null &&
                instance.OnStreamMessageError != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnStreamMessageCallback(
            uint userId,
            int streamId,
            IntPtr data,
            int length
        ...
        private static void OnConnectionBannedCallback()
        {
            if (
                instance != null &&
                instance.OnConnectionBanned != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnConnectionStateChangedCallback(
            int state,
            int reason
        )
        {
            if (
                instance != null &&
                instance.OnConnectionStateChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance
                                    .OnConnectionStateChanged((CONNECTION_STATE_TYPE)
                                    state,
        ...
        private static void OnTokenPrivilegeWillExpireCallback(string token)
        {
            if (
                instance != null &&
                instance.OnTokenPrivilegeWillExpire != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnFirstLocalVideoFrameCallback(
            int width,
            int height,
            int elapsed
        )
        {
            if (
                instance != null &&
                instance.OnFirstLocalVideoFrame != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance.OnFirstLocalVideoFrame (
                                    width,
                                    height,
                                    elapsed
                                );
        ...
        private static void OnFirstRemoteVideoFrameCallback(
            uint uid,
            int width,
            int height,
            int elapsed
        )
        {
            if (
                instance != null &&
                instance.OnFirstRemoteVideoFrame != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance.OnFirstRemoteVideoFrame (
                                    uid,
                                    width,
                                    height,
                                    elapsed
        ...
        private static void OnUserEnableVideoCallback(uint uid, bool enabled)
        {
            if (
                instance != null &&
                instance.OnUserEnableVideo != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnUserEnableLocalVideoCallback(
            uint uid,
            bool enabled
        )
        {
            if (
                instance != null &&
                instance.OnUserEnableLocalVideo != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnRemoteVideoStateChangedCallback(
            uint uid,
            int state,
            int reason,
            int elapsed
        )
        {
            if (
                instance != null &&
                instance.OnRemoteVideoStateChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnLocalPublishFallbackToAudioOnlyCallback(
            bool isFallbackOrRecover
        )
        {
            if (
                instance != null &&
                instance.OnLocalPublishFallbackToAudioOnly != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            if (
                                instance != null &&
                                instance.OnLocalPublishFallbackToAudioOnly !=
                                null
                            )
                            {
                                instance.OnLocalPublishFallbackToAudioOnly (
        ...
        [
            MonoPInvokeCallback(
                typeof (OnRemoteSubscribeFallbackToAudioOnlyHandler))
        ]
        private static void OnRemoteSubscribeFallbackToAudioOnlyCallback(
            uint uid,
            bool isFallbackOrRecover
        )
        {
            if (
                instance != null &&
                instance.OnRemoteSubscribeFallbackToAudioOnly != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            if (
                                instance != null &&
                                instance.OnRemoteSubscribeFallbackToAudioOnly !=
                                null
                            )
                            {
                                instance.OnRemoteSubscribeFallbackToAudioOnly (
        ...
        private static void OnNetworkQualityCallback(
            uint uid,
            int txQuality,
            int rxQuality
        )
        {
            if (
                instance != null &&
                instance.OnNetworkQuality != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        )
        {
            if (
                instance != null &&
                instance.OnLocalVideoStats != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                    ...
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            )
                            {
                                ...
                                localVideoStats.targetFrameRate =
                                    targetFrameRate;
                                localVideoStats.qualityAdaptIndication =
                                    (QUALITY_ADAPT_INDICATION)
                                    qualityAdaptIndication;
                                localVideoStats.encodedBitrate = encodedBitrate;
                                localVideoStats.encodedFrameWidth =
                                    encodedFrameWidth;
                                localVideoStats.encodedFrameHeight =
                                    encodedFrameHeight;
                                localVideoStats.encodedFrameCount =
                                    encodedFrameCount;
                                localVideoStats.codecType =
                                    (VIDEO_CODEC_TYPE) codecType;
                                localVideoStats.txPacketLossRate =
                                    txPacketLossRate;
                                localVideoStats.captureFrameRate =
                                    captureFrameRate;
                                localVideoStats.captureBrightnessLevel =
        ...
        private static void OnRemoteVideoStatsCallback(
            uint uid,
            int delay,
            int width,
            int height,
        ...
        )
        {
            if (
                instance != null &&
                instance.OnRemoteVideoStats != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                        ...
                        .EnQueue(() =>
                        {
                            ...
                            )
                            {
                                ...
                                remoteVideoStats.receivedBitrate =
                                    receivedBitrate;
                                remoteVideoStats.decoderOutputFrameRate =
                                ...
                                remoteVideoStats.totalFrozenTime =
                                    totalFrozenTime;
        ...
        private static void OnRemoteAudioStatsCallback(
            uint uid,
            int quality,
        ...
        )
        {
            if (
                instance != null &&
                instance.OnRemoteAudioStats != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                        ...
                        .EnQueue(() =>
                        {
                            ...
                            )
                            {
                                RemoteAudioStats remoteAudioStats =
                                    new RemoteAudioStats();
                                remoteAudioStats.uid = uid;
                                remoteAudioStats.quality = quality;
                                remoteAudioStats.networkTransportDelay =
                                ...
                                remoteAudioStats.receivedSampleRate =
                                    receivedSampleRate;
                                remoteAudioStats.receivedBitrate =
                                    receivedBitrate;
                                remoteAudioStats.totalFrozenTime =
                                    totalFrozenTime;
        ...
        private static void OnAudioDeviceStateChangedCallback(
            string deviceId,
            int deviceType,
            int deviceState
        )
        {
            if (
                instance != null &&
                instance.OnAudioDeviceStateChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance.OnAudioDeviceStateChanged (
                                    deviceId,
                                    deviceType,
                                    deviceState
                                );
        ...
        private static void OnCameraFocusAreaChangedCallback(
            int x,
            int y,
            int width,
            int height
        )
        {
            if (
                instance != null &&
                instance.OnCameraFocusAreaChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance.OnCameraExposureAreaChanged (
                                    x,
                                    y,
                                    width,
                                    height
        ...
        private static void OnCameraExposureAreaChangedCallback(
            int x,
            int y,
            int width,
            int height
        )
        {
            if (
                instance != null &&
                instance.OnCameraExposureAreaChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnRemoteAudioMixingBeginCallback()
        {
            if (
                instance != null &&
                instance.OnRemoteAudioMixingBegin != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnRemoteAudioMixingEndCallback()
        {
            if (
                instance != null &&
                instance.OnRemoteAudioMixingEnd != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnAudioEffectFinishedCallback(int soundId)
        {
            if (
                instance != null &&
                instance.OnAudioEffectFinished != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnVideoDeviceStateChangedCallback(
            string deviceId,
            int deviceType,
            int deviceState
        )
        {
            if (
                instance != null &&
                instance.OnVideoDeviceStateChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance.OnVideoDeviceStateChanged (
                                    deviceId,
                                    deviceType,
                                    deviceState
                                );
        ...
        private static void OnRemoteVideoTransportStatsCallback(
            uint uid,
            ushort delay,
            ushort lost,
            ushort rxKBitRate
        )
        {
            if (
                instance != null &&
                instance.OnRemoteVideoTransportStats != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance.OnRemoteVideoTransportStats (
                                    uid,
                                    delay,
                                    lost,
                                    rxKBitRate
        ...
        private static void OnRemoteAudioTransportStatsCallback(
            uint uid,
            ushort delay,
            ushort lost,
            ushort rxKBitRate
        )
        {
            if (
                instance != null &&
                instance.OnRemoteAudioTransportStats != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance.OnRemoteAudioTransportStats (
                                    uid,
                                    delay,
                                    lost,
                                    rxKBitRate
        ...
        private static void OnTranscodingUpdatedCallback()
        {
            if (
                instance != null &&
                instance.OnTranscodingUpdated != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        [
            MonoPInvokeCallback(
                typeof (EngineEventOnAudioDeviceVolumeChangedHandler))
        ]
        private static void OnAudioDeviceVolumeChangedCallback(
            int deviceType,
            int volume,
            bool muted
        )
        {
            if (
                instance != null &&
                instance.OnAudioDeviceVolumeChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance
                                    .OnAudioDeviceVolumeChanged((MEDIA_DEVICE_TYPE)
                                    deviceType,
                                    volume,
                                    muted);
                            }
        ...
        private static void OnMediaEngineStartCallSuccessCallback()
        {
            if (
                instance != null &&
                instance.OnMediaEngineStartCallSuccess != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnMediaEngineLoadSuccessCallback()
        {
            if (
                instance != null &&
                instance.OnMediaEngineLoadSuccess != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        [
            MonoPInvokeCallback(
                typeof (EngineEventOnAudioMixingStateChangedHandler))
        ]
        private static void OnAudioMixingStateChangedCallback(
            int audioMixingStateType,
            int audioMixingErrorType
        )
        {
            if (
                instance != null &&
                instance.OnAudioMixingStateChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance
                                    .OnAudioMixingStateChanged((AUDIO_MIXING_STATE_TYPE)
        ...
        private static void OnFirstRemoteAudioDecodedCallback(
            uint uid,
            int elapsed
        )
        {
            if (
                instance != null &&
                instance.OnFirstRemoteAudioDecoded != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance.OnFirstRemoteAudioDecoded (
                                    uid,
                                    elapsed
                                );
                            }
        ...
        private static void OnLocalVideoStateChangedCallback(
            int localVideoState,
            int error
        )
        {
            if (
                instance != null &&
                instance.OnLocalVideoStateChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance
                                    .OnLocalVideoStateChanged((LOCAL_VIDEO_STREAM_STATE)
                                    localVideoState,
        ...
        [
            MonoPInvokeCallback(
                typeof (EngineEventOnRtmpStreamingStateChangedHandler))
        ]
        private static void OnRtmpStreamingStateChangedCallback(
            string url,
            int state,
            int errCode
        )
        {
            if (
                instance != null &&
                instance.OnRtmpStreamingStateChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance
                                    .OnRtmpStreamingStateChanged(url,
        ...
        private static void OnNetworkTypeChangedCallback(int networkType)
        {
            if (
                instance != null &&
                instance.OnNetworkTypeChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance
                                    .OnNetworkTypeChanged((NETWORK_TYPE)
                                    networkType);
                            }
                        });
                }
        ...
        private static void OnLastmileProbeResultCallback(
            int state,
            uint upLinkPacketLossRate,
            uint upLinkjitter,
            uint upLinkAvailableBandwidth,
            uint downLinkPacketLossRate,
            uint downLinkJitter,
            uint downLinkAvailableBandwidth,
            uint rtt
        )
        {
            if (
                instance != null &&
                instance.OnLastmileProbeResult != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                        ...
                        .EnQueue(() =>
                        {
                            ...
                            )
                            {
                                LastmileProbeResult lastmileProbeResult =
                                    new LastmileProbeResult();
                                lastmileProbeResult.state =
                                    (LASTMILE_PROBE_RESULT_STATE) state;
                                lastmileProbeResult
                                    .uplinkReport
                                    .packetLossRate = upLinkPacketLossRate;
                                ...
                                lastmileProbeResult
                                    .downlinkReport
                                    .packetLossRate = downLinkPacketLossRate;
                                ...
                                instance.OnLastmileProbeResult (
                                    lastmileProbeResult
                                );
                            }
                        });
        ...
        private static void OnUserInfoUpdatedCallback(
            uint uid,
            uint userUid,
            string userAccount
        )
        {
            if (
                instance != null &&
                instance.OnUserInfoUpdated != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnLocalUserRegisteredCallback(
            uint uid,
            string userAccount
        )
        {
            if (
                instance != null &&
                instance.OnLocalUserRegistered != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance.OnLocalUserRegistered (
                                    uid,
                                    userAccount
                                );
                            }
        ...
        [
            MonoPInvokeCallback(
                typeof (EngineEventOnLocalAudioStateChangedHandler))
        ]
        private static void OnLocalAudioStateChangedCallback(
            int state,
            int error
        )
        {
            if (
                instance != null &&
                instance.OnLocalAudioStateChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance
                                    .OnLocalAudioStateChanged((LOCAL_AUDIO_STREAM_STATE)
                                    state,
        ...
        [
            MonoPInvokeCallback(
                typeof (EngineEventOnRemoteAudioStateChangedHandler))
        ]
        private static void OnRemoteAudioStateChangedCallback(
            uint uid,
            int state,
            int reason,
            int elapsed
        )
        {
            if (
                instance != null &&
                instance.OnRemoteAudioStateChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnLocalAudioStatsCallback(
            int numChannels,
            int sentSampleRate,
            int sentBitrate,
            ushort txPacketLossRate
        )
        {
            if (
                instance != null &&
                instance.OnLocalAudioStats != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                    ...
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            )
                            {
                                ...
                                localAudioStats.txPacketLossRate =
                                    txPacketLossRate;
        ...
        [
            MonoPInvokeCallback(
                typeof (EngineEventOnChannelMediaRelayStateChangedHandler))
        ]
        private static void OnChannelMediaRelayStateChangedCallback(
            int state,
            int code
        )
        {
            if (
                instance != null &&
                instance.OnChannelMediaRelayStateChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance
                                    .OnChannelMediaRelayStateChanged((CHANNEL_MEDIA_RELAY_STATE)
                                    state,
        ...
        [
            MonoPInvokeCallback(
                typeof (EngineEventOnChannelMediaRelayEventHandler))
        ]
        private static void OnChannelMediaRelayEventCallback(int events)
        {
            if (
                instance != null &&
                instance.OnChannelMediaRelayEvent != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance
                                    .OnChannelMediaRelayEvent((CHANNEL_MEDIA_RELAY_EVENT)
                                    events);
                            }
                        });
                }
        ...
        private static void OnFacePositionChangedCallback(
            int imageWidth,
            int imageHeight,
            int x,
            int y,
        ...
        )
        {
            if (
                instance != null &&
                instance.OnFacePositionChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                    ...
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            )
                            {
                                ...
                                instance.OnFacePositionChanged (
                                    imageWidth,
                                    imageHeight,
                                    vecRectangle,
                                    vecDistance,
        ...
        private static void OnRtmpStreamingEventCallback(
            string url,
        ...
        )
        {
            if (
                instance != null &&
                instance.OnRtmpStreamingEvent != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnAudioPublishStateChangeCallback(
            string channel,
        ...
        )
        {
            if (
                instance != null &&
                instance.OnAudioPublishStateChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance.OnAudioPublishStateChanged (
                                    channel,
                                    oldState,
                                    newState,
        ...
        private static void OnVideoPublishStateChangeCallback(
            string channel,
            STREAM_PUBLISH_STATE oldState,
            STREAM_PUBLISH_STATE newState,
            int elapseSinceLastState
        )
        {
            if (
                instance != null &&
                instance.OnVideoPublishStateChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance.OnVideoPublishStateChanged (
                                    channel,
                                    oldState,
                                    newState,
                                    elapseSinceLastState
        ...
        private static void OnAudioSubscribeStateChangeCallback(
            string channel,
            uint uid,
        ...
        )
        {
            if (
                instance != null &&
                instance.OnAudioSubscribeStateChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance.OnAudioSubscribeStateChanged (
                                    channel,
                                    uid,
                                    oldState,
                                    newState,
        ...
        private static void OnVideoSubscribeStateChangeCallback(
            string channel,
            uint uid,
            STREAM_SUBSCRIBE_STATE oldState,
            STREAM_SUBSCRIBE_STATE newState,
        ...
        )
        {
            if (
                instance != null &&
                instance.OnVideoSubscribeStateChanged != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance.OnVideoSubscribeStateChanged (
                                    channel,
                                    uid,
                                    oldState,
                                    newState,
        ...
        private static void OnFirstLocalAudioFramePublishedCallback(int elapsed)
        {
            if (
                instance != null &&
                instance.OnFirstLocalAudioFramePublished != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance.OnFirstLocalAudioFramePublished (
                                    elapsed
                                );
                            }
                        });
        ...
        private static void OnFirstLocalVideoFramePublishedCallback(int elapsed)
        {
            if (
                instance != null &&
                instance.OnFirstLocalVideoFramePublished != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance.OnFirstLocalVideoFramePublished (
                                    elapsed
                                );
                            }
                        });
        ...
        private static void OnUserSuperResolutionEnabledCallback(
            uint uid,
            bool enabled,
        ...
        )
        {
            if (
                instance != null &&
                instance.OnUserSuperResolutionEnabled != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            ...
                            {
                                instance.OnUserSuperResolutionEnabled (
                                    uid,
                                    enabled,
                                    reason
                                );
        ...
        private static void OnUploadLogResultCallback(
            string requestId,
            bool success,
        ...
        )
        {
            if (
                instance != null &&
                instance.OnUploadLogResult != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
        ...
        private static void OnVirtualBackgroundSourceEnabledCallback(
            bool enabled,
        ...
        )
        {
            if (
                instance != null &&
                instance.OnVirtualBackgroundSourceEnabled != null &&
                instance._AgoraCallbackObject != null
            )
            {
                AgoraCallbackQueue queue =
                ...
                if (!ReferenceEquals(queue, null))
                {
                    queue
                        .EnQueue(() =>
                        {
                            if (
                                instance != null &&
                                instance.OnVirtualBackgroundSourceEnabled !=
                                null
                            )
                            {
                                instance.OnVirtualBackgroundSourceEnabled (
        ...
        {
            IRtcEngineNative.initEventOnEngineCallback (
