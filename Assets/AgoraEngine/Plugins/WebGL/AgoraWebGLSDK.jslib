...
//fake methods
  adjustLoopbackRecordingSignalVolume: function( volume){
    return 0;
  },
  createDataStream_channel: function(channel, sync, ordered){
    return 0;
  },
  createDataStream_engine: function( syncWithAudio, ordered){
    return 0;
  },
  enableDeepLearningDenoise:function(enable){
    return 0;
  },
  enableVirtualBackground:function(enable, sourcyetype, color, source){
    return 0;
  },
  startAudioRecordingWithConfig:function(path, quality, position, rate){
    return 0;
  },
  getAudioMixingDuration2:function(path){
    return 0;
  },
  getEffectCurrentPosition:function(sync, ordered){
    return 0;
  },
  getEffectDuration:function(soundid){
    return 0;
  },
  isCameraTorchSupported:function(){
    return 0;
  },
  joinChannelWithMediaOption:function(token, channelid, info, uid,subscribe,autoSubVideo,localaudio,localvideo){
    return 0;
  },
  joinChannelWithUserAccount_engine:function(token, channelid, account, autoAudio,autoSubVideo,localaudio,localvideo){
    return 0;
  },
  playEffect2:function( soundId, filePath, loopCount, pitch, pan, gain, publish, startPos){
    return 0;
  },
  setCameraTorchOn:function(onOff){
    return 0;
  },
  setEffectPosition:function(soundId, pos){
    return 0;
  },
  setLocalAccessPoint:function( ips, ipSize, domain){
    return 0;
  },
  setVoiceBeautifierParameters:function( preset, param1, param2){
    return 0;
  },
  setVoiceConversionPreset:function(preset){
    return 0;
  },
  startAudioMixing2:function( filePath, loopback, replace, cycle, startPos){
    return 0;
  },
  startAudioRecordingWithConfig:function( filePath, recordingQuality, recordingPosition, recordingSampleRate){
    return 0;
  },
  switchChannel2:function( token, channelId, autoSubscribeAudio, autoSubscribeVideo, publishLocalAudio, publishLocalVideo){
    return 0;
  },
